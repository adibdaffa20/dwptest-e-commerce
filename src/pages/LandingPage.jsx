    ...
    <Box sx={{ textAlign: "center", mb: { xs: 3, md: 6 } }}>
      ...
      {subtitle && (
        <Typography
          ...
          sx={{ maxWidth: 500, mx: "auto", lineHeight: 1.7, px: { xs: 1, md: 0 } }}
        >
          {subtitle}
        </Typography>
      )}
...
const features = [
  { icon: <BoltIcon sx={{ fontSize: 22 }} />,         color: "#e91e8c", title: "Proses Instan",    desc: "Paket aktif dalam hitungan detik setelah pembayaran berhasil dikonfirmasi." },
  { icon: <LocalOfferIcon sx={{ fontSize: 22 }} />,   color: "#f59e0b", title: "Harga Terbaik",    desc: "Harga transparan, tidak ada biaya tersembunyi. Hemat setiap transaksi." },
  { icon: <SecurityIcon sx={{ fontSize: 22 }} />,     color: "#10b981", title: "Transaksi Aman",   desc: "Setiap transaksi terenkripsi dan tersimpan rapi di riwayat akun kamu." },
  { icon: <SupportAgentIcon sx={{ fontSize: 22 }} />, color: "#3b82f6", title: "Support 24/7",     desc: "Tim kami siap membantu kapan saja bila kamu mengalami kendala." },
  { icon: <PhoneAndroidIcon sx={{ fontSize: 22 }} />, color: "#8b5cf6", title: "Semua Operator",   desc: "Tersedia untuk Telkomsel, Indosat, XL, Tri, Smartfren, dan lainnya." },
  { icon: <ReceiptLongIcon sx={{ fontSize: 22 }} />,  color: "#ec4899", title: "Riwayat Lengkap",  desc: "Semua transaksi tercatat dan bisa dicek kapan saja dengan mudah." },
];

const steps = [
  { icon: <StorefrontIcon sx={{ fontSize: 24, color: "white" }} />,  title: "Pilih Paket",     desc: "Browse berbagai pilihan paket data sesuai kebutuhan dan budget kamu." },
  { icon: <PhoneAndroidIcon sx={{ fontSize: 24, color: "white" }} />, title: "Input Nomor",    desc: "Masukkan nomor tujuan — bisa untuk diri sendiri atau orang lain." },
  { icon: <BoltIcon sx={{ fontSize: 24, color: "white" }} />,         title: "Bayar & Aktif", desc: "Pilih metode pembayaran, konfirmasi, dan paket langsung aktif!" },
];
  ...
  return (
    <Box sx={{ bgcolor: "#fdf2f7", minHeight: "100vh" }}>
      ...
      <Box sx={{
        ...
        <Box sx={{ maxWidth: 1200, mx: "auto", px: { xs: 2, md: 4 }, position: "relative" }}>
          <Box sx={{
            display: "flex",
            ...
            <Box sx={{ flex: 1, minWidth: 0, width: "100%" }}>
              <Stack spacing={{ xs: 2.5, md: 3 }}>
                ...
                <Typography color="#718096" fontSize={{ xs: "0.9rem", md: "1.05rem" }} lineHeight={1.8}>
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5}>
                  <Button
                    ...
                    fullWidth={false}
                    sx={{
                      py: { xs: 1.4, md: 1.6 }, px: { xs: 3, md: 4 }, borderRadius: 3,
                      fontWeight: 700, fontSize: { xs: "0.9rem", md: "1rem" }, textTransform: "none",
                      background: "linear-gradient(135deg, #e91e8c 0%, #c2185b 100%)",
                  ...
                  <Button
                    ...
                    sx={{
                      py: { xs: 1.4, md: 1.6 }, px: { xs: 3, md: 4 }, borderRadius: 3,
                      fontWeight: 600, fontSize: { xs: "0.9rem", md: "1rem" }, textTransform: "none",
                ...
                <Stack direction="row" spacing={{ xs: 1.5, md: 2.5 }} flexWrap="wrap" useFlexGap>
                  {["Checkout < 30 detik", "Harga transparan", "Riwayat lengkap"].map((t) => (
                    <Stack key={t} direction="row" alignItems="center" spacing={0.5}>
                      ...
                      <Typography fontSize={{ xs: "0.75rem", md: "0.82rem" }} color="#4a5568" fontWeight={600}>{t}</Typography>
                    </Stack>
                  ))}
                </Stack>
              </Stack>
            ...
            <Box sx={{
              ...
              <Box sx={{ position: "relative", width: "100%", maxWidth: { xs: "100%", sm: 400 } }}>
                <Card sx={{
                  borderRadius: 4, border: "1px solid #fce4ec",
                  ...
                  <CardContent sx={{ p: { xs: 2, md: 3 } }}>
                    ...
                    <Stack spacing={1.25}>
                      {[
                        ...
                        <Box key={pkg.name} sx={{
                          px: { xs: 1.5, md: 2 }, py: 1.5, borderRadius: 2.5,
                          ...
                          <Box sx={{ minWidth: 0, flex: 1 }}>
                            ...
                            <Typography fontSize="0.72rem" color="#a0aec0" mt={0.25}>{pkg.days}</Typography>
                          </Box>
                          <Typography fontWeight={900} fontSize="0.9rem" flexShrink={0} sx={{
                            background: "linear-gradient(135deg, #e91e8c, #c2185b)",
                ...
                <Box sx={{
                  ...
                  alignItems: "center", gap: 0.5, zIndex: 1,
                }}>
      ...
      {/* ── 2. STATS ── */}
      <Box sx={{ bgcolor: "white", borderTop: "1px solid #fce4ec", borderBottom: "1px solid #fce4ec" }}>
            ...
            {stats.map((s, i) => (
              <Grid item xs={6} md={3} key={i}>
                <Box sx={{
                  ...
                  <Typography fontSize={{ xs: "0.72rem", md: "0.9rem" }} color="#a0aec0" fontWeight={600} textAlign="center">
                    {s.label}
                  </Typography>
                </Box>
              </Grid>
        ...
        <Box sx={{
          ...
          {features.map((f, i) => (
            <Card key={i} sx={{
              ...
              "&:hover": { transform: "translateY(-4px)", boxShadow: `0 16px 36px ${f.color}22`, borderColor: f.color + "55" },
            }}>
              <CardContent sx={{ p: { xs: 2, md: 3 }, flex: 1, display: "flex", flexDirection: "column", "&:last-child": { pb: { xs: 2, md: 3 } } }}>
                <Box sx={{
                  width: { xs: 40, md: 50 }, height: { xs: 40, md: 50 }, borderRadius: 2.5,
                ...
                <Typography fontWeight={800} fontSize={{ xs: "0.82rem", md: "0.975rem" }} color="#2d3748" mb={0.75}>
                  {f.title}
                </Typography>
                <Typography fontSize={{ xs: "0.75rem", md: "0.845rem" }} color="#718096" lineHeight={1.6} sx={{ flex: 1 }}>
                  {f.desc}
                </Typography>
              </CardContent>
            </Card>
      ...
      <Box sx={{
        bgcolor: "white",
        borderTop: "1px solid #fce4ec", borderBottom: "1px solid #fce4ec",
        py: { xs: 5, md: 10 },
      }}>
        <Container maxWidth="lg">
            ...
            {steps.map((s, i) => (
              <Grid item xs={12} sm={4} key={i} sx={{ display: "flex" }}>
                <Card sx={{
                  ...
                  transition: "all 0.3s ease",
                  "&:hover": { transform: "translateY(-4px)", boxShadow: "0 16px 36px rgba(233,30,140,0.12)" },
                }}>
                  <CardContent sx={{ p: { xs: 2.5, md: 3.5 }, display: "flex", flexDirection: { xs: "row", sm: "column" }, alignItems: "center", gap: { xs: 2, sm: 0 } }}>
                    <Box sx={{
                      width: { xs: 52, md: 64 }, height: { xs: 52, md: 64 }, borderRadius: 3,
                      mb: { xs: 0, sm: 2 }, flexShrink: 0,
                      background: "linear-gradient(135deg, #e91e8c 0%, #c2185b 100%)",
                      display: "flex", alignItems: "center", justifyContent: "center",
                    ...
                    <Box sx={{ textAlign: { xs: "left", sm: "center" } }}>
                      <Typography fontWeight={800} fontSize={{ xs: "0.9rem", md: "1.05rem" }} color="#2d3748" mb={0.5}>
                        {s.title}
                      </Typography>
                      <Typography fontSize={{ xs: "0.78rem", md: "0.85rem" }} color="#718096" lineHeight={1.6}>
                        {s.desc}
                      </Typography>
                    </Box>
                  </CardContent>
          ...
          <Box sx={{ textAlign: "center", mt: { xs: 3, md: 5 } }}>
            <Button
              ...
              variant="contained" size="large" endIcon={<ArrowForwardIcon />}
              sx={{
                py: 1.5, px: { xs: 4, md: 5 }, borderRadius: 3,
                fontWeight: 700, textTransform: "none", fontSize: { xs: "0.9rem", md: "1rem" },
                background: "linear-gradient(135deg, #e91e8c 0%, #c2185b 100%)",
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 5, md: 8 } }}>
        ...
        />
        <Stack direction="row" flexWrap="wrap" justifyContent="center" gap={{ xs: 1.5, md: 2 }}>
          {operators.map((op) => (
            <Card key={op} sx={{
              borderRadius: 3, border: "1px solid #fce4ec",
              px: { xs: 2, md: 3 }, py: { xs: 1.5, md: 2 }, bgcolor: "white",
              transition: "all 0.25s ease",
              "&:hover": { borderColor: "#e91e8c", boxShadow: "0 8px 20px rgba(233,30,140,0.12)", transform: "translateY(-2px)" },
            }}>
              <Stack direction="row" alignItems="center" gap={1.25}>
                <Box sx={{
                  ...
                  <WifiIcon sx={{ color: "white", fontSize: { xs: 14, md: 17 } }} />
                </Box>
                <Typography fontWeight={800} fontSize={{ xs: "0.8rem", md: "0.9rem" }} color="#2d3748">{op}</Typography>
              </Stack>
            </Card>
          ))}
        </Stack>
        ...
        <Box sx={{ position: "relative", overflow: "hidden", width: "100%" }}>
          ...
          <Box sx={{
            ...
            {[...testimonials, ...testimonials].map((t, i) => (
              <Card key={i} sx={{
                borderRadius: 3, border: "1px solid #fce4ec", bgcolor: "#fff8fb",
                width: { xs: 250, sm: 300, md: 320 },
                flexShrink: 0, display: "flex", flexDirection: "column",
                "&:hover": { boxShadow: "0 16px 36px rgba(233,30,140,0.12)" },
              }}>
                <CardContent sx={{ p: { xs: 2, md: 3 }, flex: 1, display: "flex", flexDirection: "column", "&:last-child": { pb: { xs: 2, md: 3 } } }}>
                  <FormatQuoteIcon sx={{ fontSize: { xs: 24, md: 30 }, color: "#f48fb1", mb: 1.5, flexShrink: 0 }} />
                  <Typography fontSize={{ xs: "0.8rem", md: "0.875rem" }} color="#4a5568" lineHeight={1.8} fontStyle="italic" sx={{ flex: 1, mb: 2 }}>
                    "{t.text}"
                  </Typography>
                  ...
                  <Stack direction="row" alignItems="center" justifyContent="space-between" gap={1}>
                    <Stack direction="row" alignItems="center" gap={1} sx={{ minWidth: 0 }}>
                      ...
                      <Box sx={{ minWidth: 0 }}>
                        <Typography fontWeight={700} fontSize="0.82rem" color="#2d3748" noWrap>{t.name}</Typography>
                        <Typography fontSize="0.7rem" color="#a0aec0" noWrap>{t.role}</Typography>
                      </Box>
                    </Stack>
                    <Stack direction="row" gap={0.25} flexShrink={0}>
                      {Array.from({ length: t.rating }).map((_, si) => (
                        <StarIcon key={si} sx={{ fontSize: { xs: 12, md: 14 }, color: "#fbbf24" }} />
                      ))}
                    </Stack>
                  </Stack>
                </CardContent>
              ...
              <CardContent sx={{ p: { xs: 2, md: 2.5 }, "&:last-child": { pb: { xs: 2, md: 2.5 } } }}>
                <Stack direction="row" gap={1.5} alignItems="flex-start">
                  <Box sx={{
                    ...
                    background: "linear-gradient(135deg, #e91e8c, #c2185b)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    boxShadow: "0 3px 8px rgba(233,30,140,0.25)", mt: 0.25,
                  }}>
                    <Typography color="white" fontWeight={900} fontSize="0.7rem">Q</Typography>
                  </Box>
                  <Box>
                    <Typography fontWeight={700} fontSize={{ xs: "0.85rem", md: "0.95rem" }} color="#2d3748" mb={0.5}>{f.q}</Typography>
                    <Typography fontSize={{ xs: "0.8rem", md: "0.875rem" }} color="#718096" lineHeight={1.7}>{f.a}</Typography>
                  </Box>
                </Stack>
              </CardContent>
            </Card>
      ...
      {/* ── 8. CTA BANNER ── */}
      <Box sx={{ pb: { xs: 5, md: 10 }, px: { xs: 2, md: 2 } }}>
        <Container maxWidth="md">
          <Card sx={{
            ...
            <CardContent sx={{ py: { xs: 4, md: 7 }, px: { xs: 2.5, md: 6 }, textAlign: "center", position: "relative" }}>
              <Typography fontWeight={900} fontSize={{ xs: "1.3rem", sm: "1.6rem", md: "2.2rem" }} color="white" lineHeight={1.2} mb={1.5}>
                Siap mulai hemat dengan Kuotify?
              </Typography>
              <Typography color="rgba(255,255,255,0.85)" fontSize={{ xs: "0.88rem", md: "1rem" }} mb={3.5} lineHeight={1.7}>
              ...
              <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5} justifyContent="center">
                <Button
                  ...
                  variant="contained" size="large" endIcon={<ArrowForwardIcon />}
                  sx={{
                    py: 1.5, px: { xs: 3, md: 5 }, borderRadius: 3,
                    bgcolor: "white", color: "#e91e8c",
                    fontWeight: 800, fontSize: { xs: "0.9rem", md: "1rem" }, textTransform: "none",
                    boxShadow: "0 8px 24px rgba(0,0,0,0.15)",
                    "&:hover": { bgcolor: "#fff0f7", transform: "translateY(-2px)" },
                    transition: "all 0.25s ease",
                  }}
                >
                  Daftar Gratis
      ...
      {/* ── 9. FOOTER ── */}
      <Box sx={{ bgcolor: "white", borderTop: "1px solid #fce4ec", py: { xs: 3, md: 4 } }}>
        <Container maxWidth="lg">
